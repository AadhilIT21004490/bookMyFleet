					...
					<div className="main-header">
						<div className="header-left">
							...
							<Link
								...
								className="d-flex align-items-center bg-primary border rounded-3 px-3 py-2 text-black text-decoration-none"
								style={{ fontSize: "0.9rem" }}
							>
								<Handshake size={18} />
								{/* Show text only on md and larger screens */}
								<strong className="ml-2 d-none d-md-inline">Become a vendor</strong>
							</Link>
